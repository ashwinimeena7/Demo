...
sap.ui.define([
	...
	return Controller.extend("ZDeputation.controller.OverseasDeputation", {
		...
		onInit: function () {
			...
			this.errorDialog = sap.ui.xmlfragment("ZDeputation.view.fragment.errorMsgDialog", this);
			...
			this.OvrClientNamef4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrClientNamef4", this);
			this.getView().addDependent(this.OvrClientNamef4);

			this.OvrTravelToCountryf4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrTravelToCountryf4", this);
			this.getView().addDependent(this.OvrTravelToCountryf4);

			this.OvrTravelToLocf4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrTravelToLocf4", this);
			this.getView().addDependent(this.OvrTravelToLocf4);

			this.OvrBillRateF4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrBillRateF4", this);
			this.getView().addDependent(this.OvrBillRateF4);

			this.OvrPOF4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrPOF4", this);
			this.getView().addDependent(this.OvrPOF4);

			this.OvrRoleF4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrRoleF4", this);
			this.getView().addDependent(this.OvrRoleF4);

			this.OvrIRMF4 = sap.ui.xmlfragment("ZDeputation.view.fragment.OvrIRMF4", this);
			this.getView().addDependent(this.OvrIRMF4);
		},
		...
		goToBack: function () {
			...
			if (oOvrSelectedModel.oData.Operation === 'C') {
				var fromCity = this.getView().byId("fromCity");
				...
				var toVisaCaseNo = this.getView().byId("toVisaCaseNo");
				var toVisaPermitType = this.getView().byId("toVisaPermitType");
				var sClientLocation = this.getView().byId("clientLocation");
				var sClientCountry = this.getView().byId("clientCountry");
				var sClientCity = this.getView().byId("clientCity");
				...
				var clientName = this.getView().byId("clientName");
				var Rate = this.getView().byId("Rate");
				var PO = this.getView().byId("PO");
				var IRM = this.getView().byId("IRM");
				var Role = this.getView().byId("Role");
			...
			if (oOvrSelectedModel.oData.Operation === 'M') {
				var fromCity = this.getView().byId("fromCityMod");
				...
				var toVisaCaseNo = this.getView().byId("toVisaCaseNoMod");
				var toVisaPermitType = this.getView().byId("toVisaPermitTypeMod");
				var sClientLocation = this.getView().byId("clientLocationMod");
				var sClientCountry = this.getView().byId("clientCountryMod");
				var sClientCity = this.getView().byId("clientCityMod");
				var sClientAdd1 = this.getView().byId("clientAdd1Mod");
				var sClientAdd2 = this.getView().byId("clientAdd2Mod");
				var sClientPin = this.getView().byId("clientPincodeMod");
				var clientName = this.getView().byId("clientNameMod");
				var Rate = this.getView().byId("RateMod");
				var PO = this.getView().byId("POMod");
				var IRM = this.getView().byId("IRMMod");
				var Role = this.getView().byId("RoleMod");
				var sRemarks = this.getView().byId("toRemarksMod");
			}
		...
		refershDept: function () {
			debugger;
			var that = this;
			if (this.getView().getModel("oOvrSelectedModel").getData().Operation == 'M') {
				var sPjctID = this.getView().getModel("oOvrSelectedModel").getData().ProjectId;

			} else {
				var sPjctID = this.getView().getModel("oOvrSelectedModel").getData().Zzl1Wbs;
			}
			...
			that.getView().getParent().getParent().getParent().byId("deptSearchView").getController().onOvrPjctDisplay(sType, sPjctID);
		},
		...
		validateCreate: function () {
			...
			if (oFromData.Operation === "C") {
				// var sStdate = this.getView().byId("toStrtDate").getValue();
				// var sEndate = this.getView().byId("toEndDate").getValue();
				// var sCountry = this.getView().byId("toCountry").getValue();
				// var sLoc = this.getView().byId("toLocation").getValue();
				var sFrmCity = this.getView().byId("fromCity");
				var toVisaCaseNo = this.getView().byId("toVisaCaseNo");
				var toVisaPermitType = this.getView().byId("toVisaPermitType");
				var sClientLocation = this.getView().byId("clientLocation");
				var sClientCountry = this.getView().byId("clientCountry");
				...
				if (oFromData.ProjType === 'X' && Rate.getValue() === "") {
					...
					if (sFrmCity.getValue() === "" || toVisaCaseNo.getValue() === "" || toVisaPermitType.getValue() === "" || sClientLocation.getValue() ===
						"" || sClientCountry.getValue() === "" || sClientCity.getValue() === "" || sClientAdd1.getValue() === "" || sClientPin.getValue() ===
						"" || sClientAdd2.getValue() === "" || clientName.getValue() === "" ||
						Role.getValue() === "" || IRM.getValue() === ""
					) {
						/*	if (Rate.getValue() === "") {
								createValid.push(Rate);
							}*/
				...
				//	if (sRemarks.getValue() === "" || sFrmCity.getValue() === "") {
				...
				// var sStdate = this.getView().byId("toStrtDateMod").getValue();
				// var sEndate = this.getView().byId("toEndDateMod").getValue();
				// var sCountry = this.getView().byId("toCountryMod").getValue();
				// var sLoc = this.getView().byId("toLocationMod").getValue();
				var sFrmCity = this.getView().byId("fromCityMod");
				var sToCity = this.getView().byId("toCityMod");
				var sClientLocation = this.getView().byId("clientLocationMod");
				var sClientCountry = this.getView().byId("clientCountryMod");
				var sClientCity = this.getView().byId("clientCityMod");
				var toVisaPermitType = this.getView().byId("toVisaPermitTypeMod");
				// var sClientName = this.getView().byId("clientNameMod").getValue();
				var sClientAdd1 = this.getView().byId("clientAdd1Mod");
				var sClientAdd2 = this.getView().byId("clientAdd2Mod");
				var sClientPin = this.getView().byId("clientPincodeMod");
				var sRemarks = this.getView().byId("toRemarksMod");
				...
				if (oFromData.ProjType === 'X' && Rate.getValue() === "") {
					...
					if (sRemarks.getValue() === "" || toVisaPermitType.getValue() === "" || sFrmCity.getValue() === "" || sToCity.getValue() === "" ||
						sClientLocation.getValue() === "" ||
						sClientCountry.getValue() === "" || sClientCity.getValue() === "" ||
						sClientAdd1.getValue() === "" || sClientPin.getValue() === "" || sClientAdd2.getValue() === "" ||
						Role.getValue() === "" || IRM.getValue() === "") {
						/*	if (Rate.getValue() === "") {
								createValid.push(Rate);
		...
		resetCreate: function () {
			this.getView().byId("toRemarks").setValue();
			this.getView().byId("fromCity").setValue();
			this.getView().byId("toCity").setValue();
			this.getView().byId("clientLocation").setValue();
			this.getView().byId("clientCountry").setValue();
			this.getView().byId("clientCity").setValue();
			this.getView().byId("clientAdd1").setValue();
			this.getView().byId("clientAdd2").setValue();
			this.getView().byId("clientPincode").setValue();
			if (!(this.getView().getModel("OvisaClientModel") == undefined)) {
				this.getView().getModel("OvisaClientModel").setData();
				this.getView().getModel("OvisaClientModel").refresh();
			}
		...
		checkToStartDate: function (oEvent) {
			debugger;
			var oAllocModel = this.getView().getModel("oAllocSelectedModel").getData();
			var sBeddaYear = oAllocModel.Begda.substr(0, 4);
			var sBegdaMonth = oAllocModel.Begda.substr(4, 2);
			var sBegdaDay = oAllocModel.Begda.substr(6, 2);
			var sAllocStartDate = new Date(sBeddaYear + "-" + sBegdaMonth + "-" + sBegdaDay);
			sAllocStartDate = sAllocStartDate.setHours(0, 0, 0, 0);
			var sEnddaYear = oAllocModel.Endda.substr(0, 4);
			var sEnddaMonth = oAllocModel.Endda.substr(4, 2);
			var sEnddaDay = oAllocModel.Endda.substr(6, 2);
			var sAllocEndDate = new Date(sEnddaYear + "-" + sEnddaMonth + "-" + sEnddaDay);
			sAllocEndDate = sAllocEndDate.setHours(0, 0, 0, 0);
			var sToStDate = (oEvent.getSource().getDateValue()).setHours(0, 0, 0, 0);
			if (sToStDate < sAllocStartDate) {
				oEvent.getSource().setValue();
			} else if (sToStDate > sAllocEndDate) {
				oEvent.getSource().setValue();
			}

		},

		checkToEndDate: function (oEvent) {
			debugger;
			var sToStartDate = this.getView().byId("toStrtDate").getDateValue();
			if (sToStartDate !== null) {
				var oAllocModel = this.getView().getModel("oAllocSelectedModel").getData();
				var sToStartDateHours = (sToStartDate).setHours(0, 0, 0, 0);
				var sEnddaYear = oAllocModel.Endda.substr(0, 4);
				var sEnddaMonth = oAllocModel.Endda.substr(4, 2);
				var sEnddaDay = oAllocModel.Endda.substr(6, 2);
				var sAllocEndDate = new Date(sEnddaYear + "-" + sEnddaMonth + "-" + sEnddaDay);
				sAllocEndDate = sAllocEndDate.setHours(0, 0, 0, 0);
				var sToEndDate = (oEvent.getSource().getDateValue()).setHours(0, 0, 0, 0);
				if (sToEndDate < sToStartDateHours) {
					oEvent.getSource().setValue();
				} else if (sToEndDate > sAllocEndDate) {
					oEvent.getSource().setValue();
				}
			} else {
				oEvent.getSource().setValue();
		...
		onAfterRendering: function () {
			debugger;
			var homePage = this.getOwnerComponent()._oViews._oViews["ZDeputation.view.DeputationSearch"];
